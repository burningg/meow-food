...
const alliumIngredientNames = [
  '蒜', '葱', '大葱', '小葱', '香葱', '青葱', '老葱', '火葱', '分葱', '胡葱', '红葱', '红葱头', '圆葱', '洋葱',
  '紫洋葱', '白洋葱', '黄洋葱', '甜洋葱', '珍珠洋葱', '韭葱', '青蒜', '大蒜', '蒜头', '蒜瓣', '独头蒜', '紫皮蒜',
  '白皮蒜', '腊八蒜', '糖蒜', '姜', '生姜', '老姜', '嫩姜', '子姜', '姜芽', '沙姜', '山奈', '南姜', '良姜',
  '高良姜', '黄姜', '姜黄', '洋姜', '鬼子姜', '菊芋', '蒜米', '蒜泥', '姜汁', '姜末', '葱花', '蒜碎', '野葱',
  '薤白', '藠头', '葱姜蒜',
]
const condimentIngredientNames = [
  '油', '酒', '粉', '盐', '食盐', '井盐', '海盐', '湖盐', '低钠盐', '椒盐', '白糖', '白砂糖', '绵白糖', '红糖',
  '黑糖', '黄糖', '冰糖', '方糖', '糖粉', '蜂蜜', '枫糖浆', '酱油', '生抽', '老抽', '味极鲜', '蒸鱼豉油',
  '鱼露', '蚝油', '醋', '陈醋', '香醋', '米醋', '白醋', '大红浙醋', '果醋', '料酒', '黄酒', '花雕酒', '白酒',
  '米酒', '啤酒', '葡萄酒', '食用油', '植物油', '菜籽油', '花生油', '大豆油', '豆油', '玉米油', '葵花籽油',
  '橄榄油', '茶油', '山茶油', '芝麻油', '香油', '花椒油', '辣椒油', '红油', '葱油', '蒜油', '猪油', '黄油',
  '牛油', '人造黄油', '起酥油', '椰油', '棕榈油', '亚麻籽油', '核桃油', '牛油果油', '豆瓣酱', '郫县豆瓣',
  '黄豆酱', '黄酱', '甜面酱', '面酱', '芝麻酱', '花生酱', '沙拉酱', '蛋黄酱', '美乃滋', '千岛酱', '番茄酱',
  '番茄沙司', '辣椒酱', '蒜蓉辣酱', '剁椒', '泡椒', '豆豉', '水豆豉', '干豆豉', '腐乳', '豆腐乳', '南乳',
  '红腐乳', '白腐乳', '臭腐乳', '韭菜花酱', '虾酱', '蟹酱', '鱼子酱', '芥末', '青芥辣', '山葵酱', '芥末酱',
  '辣根', '蜂蜜芥末酱', '黄芥末酱', '味噌', '豆味噌', '咖喱', '咖喱块', '咖喱粉', '咖喱酱', '黄咖喱', '红咖喱',
  '绿咖喱', '冬阴功酱', '沙茶酱', '沙嗲酱', 'XO酱', '柱侯酱', '海鲜酱', '排骨酱', '叉烧酱', '甜辣酱',
  '泰式甜辣酱', '照烧酱', '黑椒酱', '烧烤酱', '牛排酱', '芝士酱', '塔塔酱', '凯撒酱', '味精', '味素', '鸡精',
  '鸡粉', '蘑菇精', '蔬之鲜', '高汤粉', '浓汤宝', '松鲜鲜', '五香粉', '十三香', '七味粉', '香辛料', '花椒',
  '花椒粉', '麻椒', '藤椒', '青花椒', '胡椒', '胡椒粉', '白胡椒粉', '黑胡椒粉', '胡椒碎', '辣椒粉', '辣椒面',
  '辣椒碎', '孜然', '孜然粉', '小茴香', '小茴香粉', '八角', '大料', '桂皮', '肉桂', '桂枝', '香叶', '月桂叶',
  '丁香', '草果', '草豆蔻', '白豆蔻', '肉豆蔻', '豆蔻', '砂仁', '栀子', '陈皮', '甘草', '罗汉果', '百里香',
  '迷迭香', '披萨草', '牛至', '罗勒', '紫苏', '薄荷', '香茅', '柠檬草', '莳萝', '茴香', '芹菜籽', '芥菜籽',
  '黄芥末籽', '黑芥末籽', '罂粟籽', '奇亚籽', '芝麻', '白芝麻', '黑芝麻', '酵母', '酵母粉', '泡打粉', '塔塔粉',
  '小苏打', '苏打粉', '碱面', '食用碱', '烧烤料', '腌肉料', '炸鸡粉', '面包糠', '蒸肉米粉', '蒸肉粉', '卤料',
  '卤料包', '火锅底料', '火锅料', '麻辣烫底料', '麻辣烫料', '酸菜鱼料', '酸菜鱼底料', '水煮鱼料', '水煮鱼底料',
  '回锅肉调料', '回锅肉料', '鱼香肉丝调料', '鱼香肉丝料', '宫保鸡丁调料', '宫保鸡丁料', '麻婆豆腐调料',
  '麻婆豆腐料', '红烧肉调料', '红烧肉料', '糖醋汁', '糖醋料', '照烧汁', '照烧料', '黑椒汁', '黑椒料', '意面酱',
  '披萨酱', '芝士粉', '芝士片', '炼乳', '巧克力酱', '果酱', '蓝莓酱', '草莓酱', '橙子酱', '红烧汁', '卤水汁',
  '凉拌汁', '捞拌汁', '油醋汁', '韩式烤肉酱', '大酱', '韩式辣酱',
]
const seasoningIngredientNames = new Set([...alliumIngredientNames, ...condimentIngredientNames])
...
function sortShoppingItems(items: PlanShoppingItem[]) {
  ...
  const seasoningItems: PlanShoppingItem[] = []

  // 前端只做分组重排：普通食材保持原顺序，调料类整体沉到底部。
  items.forEach((item) => {
    if (isSeasoningIngredient(item.ingredientName)) {
      seasoningItems.push(item)
      return
    }
...
function isSeasoningIngredient(name: string) {
  return seasoningIngredientNames.has(name.trim())
}
